...
class StoreProductRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'price.min' => 'O preço deve ser no mínimo '.config('shop.currency_symbol').' :min.',
            ...
            'image.mimes' => 'A imagem deve ser do tipo '.image_mimes_label().'.',
            'image.max' => 'A imagem não pode ultrapassar '.image_max_label().'.',
