...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas contêm as mensagens de erro padrão usadas pela classe
    | de validação. Algumas dessas regras possuem múltiplas versões, como as
    | regras de tamanho. Sinta-se à vontade para ajustar cada mensagem conforme
    | necessário.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui você pode especificar mensagens personalizadas para regras
    | específicas do atributo usando a convenção:
    | "attribute.rule" => "mensagem".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Substitui :attribute por nomes mais amigáveis para o usuário.
    |
    */
